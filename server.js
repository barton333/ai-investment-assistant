...
const allProducts = [
  ...
  // ─── 中国银行理财产品 ───
  { code:'ZH001001',name:'中银理财-稳富(封闭式)2025年01期',type:'理财', market:'银行理财', focus:'固收/稳健' },
  { code:'ZH001002',name:'中银理财-稳富(封闭式)2025年02期',type:'理财', market:'银行理财', focus:'固收/稳健' },
  { code:'ZH001003',name:'中银理财-稳富(封闭式)2025年03期',type:'理财', market:'银行理财', focus:'固收/稳健' },
  { code:'ZH001004',name:'中银理财-稳富(封闭式)2025年04期',type:'理财', market:'银行理财', focus:'固收/稳健' },
  { code:'ZH001005',name:'中银理财-稳富(封闭式)2025年05期',type:'理财', market:'银行理财', focus:'固收/稳健' },
  { code:'ZH001006',name:'中银理财-稳富(封闭式)2025年06期',type:'理财', market:'银行理财', focus:'固收/稳健' },
  { code:'ZH001007',name:'中银理财-稳富(封闭式)2025年07期',type:'理财', market:'银行理财', focus:'固收/稳健' },
  { code:'ZH001008',name:'中银理财-稳富(封闭式)2025年08期',type:'理财', market:'银行理财', focus:'固收/稳健' },
  { code:'ZH001009',name:'中银理财-稳富(封闭式)2025年09期',type:'理财', market:'银行理财', focus:'固收/稳健' },
  { code:'ZH001010',name:'中银理财-稳富(封闭式)2025年10期',type:'理财', market:'银行理财', focus:'固收/稳健' },
  { code:'BY100001',name:'中银理财-智富(权益增强)2025年01期',type:'理财', market:'银行理财', focus:'权益/混合' },
  { code:'BY100002',name:'中银理财-智富(权益增强)2025年02期',type:'理财', market:'银行理财', focus:'权益/混合' },
  { code:'BY100003',name:'中银理财-智富(权益增强)2025年03期',type:'理财', market:'银行理财', focus:'权益/混合' },
  { code:'ZY020001',name:'中银理财-低碳优享2025年01期',type:'理财', market:'银行理财', focus:'ESG/低碳' },
  { code:'ZY020002',name:'中银理财-低碳优享2025年02期',type:'理财', market:'银行理财', focus:'ESG/低碳' },
  { code:'ZY020003',name:'中银理财-低碳优享2025年03期',type:'理财', market:'银行理财', focus:'ESG/低碳' },
  // 中银理财现金管理类
  { code:'ZYH001',name:'中银理财-乐享天天(现金管理)',type:'理财', market:'银行理财', focus:'现金管理/T+1' },
  { code:'ZYH002',name:'中银理财-惠享天天(现金管理)',type:'理财', market:'银行理财', focus:'现金管理/T+0' },
  { code:'ZYH003',name:'中银理财-欣享天天(现金管理)',type:'理财', market:'银行理财', focus:'现金管理/T+0' },
  // 中银美元理财产品
  { code:'ZYUSD01',name:'中银理财-美元乐享天天',type:'理财', market:'银行理财', focus:'美元/现金管理' },
  { code:'ZYUSD02',name:'中银理财-美元稳富(3个月)',type:'理财', market:'银行理财', focus:'美元/短期' },
  { code:'ZYUSD03',name:'中银理财-美元智富(6个月)',type:'理财', market:'银行理财', focus:'美元/中期' },

  // ─── 招商银行理财产品 ───
  { code:'CMB001',name:'招银理财-金葵系列日日聚鑫',type:'理财', market:'银行理财', focus:'现金管理/T+0' },
  { code:'CMB002',name:'招银理财-金葵系列日日聚益',type:'理财', market:'银行理财', focus:'现金管理/T+0' },
  { code:'CMB003',name:'招银理财-金葵系列周周发',type:'理财', market:'银行理财', focus:'短期/周度' },
  { code:'CMB004',name:'招银理财-金葵系列月月宝',type:'理财', market:'银行理财', focus:'短期/月度' },
  { code:'CMB005',name:'招银理财-金葵系列季季宝',type:'理财', market:'银行理财', focus:'中期/季度' },
  { code:'CMB006',name:'招银理财-金葵系列半年宝',type:'理财', market:'银行理财', focus:'中期/半年' },
  { code:'CMB007',name:'招银理财-金葵系列年年宝',type:'理财', market:'银行理财', focus:'长期/年' },
  { code:'CMB008',name:'招银理财-金葵系列两年宝',type:'理财', market:'银行理财', focus:'长期/两年' },
  // 招银理财青葵系列
  { code:'QK001',name:'招银理财-青葵系列半年开',type:'理财', market:'银行理财', focus:'固收/半年开放' },
  { code:'QK002',name:'招银理财-青葵系列一年开',type:'理财', market:'银行理财', focus:'固收/年开放' },
  { code:'QK003',name:'招银理财-青葵系列两年开',type:'理财', market:'银行理财', focus:'固收/两年开放' },
  // 招银理财卓远系列
  { code:'ZY1001',name:'招银理财-卓远系列(3个月)',type:'理财', market:'银行理财', focus:'固收+/3个月' },
  { code:'ZY1002',name:'招银理财-卓远系列(6个月)',type:'理财', market:'银行理财', focus:'固收+/6个月' },
  { code:'ZY1003',name:'招银理财-卓远系列(12个月)',type:'理财', market:'银行理财', focus:'固收+/12个月' },
  // 招银理财美元产品
  { code:'CMBUSD1',name:'招银理财-美元金葵系列(3个月)',type:'理财', market:'银行理财', focus:'美元/短期' },
  { code:'CMBUSD2',name:'招银理财-美元金葵系列(6个月)',type:'理财', market:'银行理财', focus:'美元/中期' },
  { code:'CMBUSD3',name:'招银理财-美元金葵系列(12个月)',type:'理财', market:'银行理财', focus:'美元/长期' },
  // 招银理财高净值
  { code:'CMBP001',name:'招银理财-私行金葵系列A款',type:'理财', market:'银行理财', focus:'高净值/混合' },
  { code:'CMBP002',name:'招银理财-私行金葵系列B款',type:'理财', market:'银行理财', focus:'高净值/混合' },

  // ─── 腾讯理财通（货币基金 + 理财） ───
  { code:'TXLC001',name:'理财通-余额+(货币基金)',type:'理财', market:'腾讯理财', focus:'货币基金/T+0' },
  { code:'TXLC002',name:'理财通-安稳债基',type:'理财', market:'腾讯理财', focus:'债券/稳健' },
  { code:'TXLC003',name:'理财通-指数基金(沪深300)',type:'理财', market:'腾讯理财', focus:'指数/沪深300' },
  { code:'TXLC004',name:'理财通-指数基金(中证500)',type:'理财', market:'腾讯理财', focus:'指数/中证500' },
  { code:'TXLC005',name:'理财通-指数基金(纳斯达克)',type:'理财', market:'腾讯理财', focus:'指数/纳斯达克' },
  { code:'TXLC006',name:'理财通-黄金ETF联接',type:'理财', market:'腾讯理财', focus:'黄金/商品' },
  { code:'TXLC007',name:'理财通-科技创新混合',type:'理财', market:'腾讯理财', focus:'科技/创新' },
  { code:'TXLC008',name:'理财通-消费升级混合',type:'理财', market:'腾讯理财', focus:'消费/升级' },
  { code:'TXLC009',name:'理财通-医疗健康混合',type:'理财', market:'腾讯理财', focus:'医疗/健康' },
  { code:'TXLC010',name:'理财通-新能源主题',type:'理财', market:'腾讯理财', focus:'新能源/低碳' },
  // 理财通保险产品
  { code:'TXBX001',name:'理财通-太平养老(30天)',type:'理财', market:'腾讯理财', focus:'养老保障/30天' },
  { code:'TXBX002',name:'理财通-太平养老(60天)',type:'理财', market:'腾讯理财', focus:'养老保障/60天' },
  { code:'TXBX003',name:'理财通-国寿养老(90天)',type:'理财', market:'腾讯理财', focus:'养老保障/90天' },
  { code:'TXBX004',name:'理财通-平安养老(180天)',type:'理财', market:'腾讯理财', focus:'养老保障/180天' },
  { code:'TXBX005',name:'理财通-泰康养老(360天)',type:'理财', market:'腾讯理财', focus:'养老保障/360天' },
  // 理财通基金投顾
  { code:'TXTG001',name:'理财通-基金投顾(稳健型)',type:'理财', market:'腾讯理财', focus:'投顾/稳健' },
  { code:'TXTG002',name:'理财通-基金投顾(平衡型)',type:'理财', market:'腾讯理财', focus:'投顾/平衡' },
  { code:'TXTG003',name:'理财通-基金投顾(进取型)',type:'理财', market:'腾讯理财', focus:'投顾/进取' },
  { code:'TXTG004',name:'理财通-基金投顾(激进型)',type:'理财', market:'腾讯理财', focus:'投顾/激进' },

  // ─── 支付宝理财/蚂蚁财富 ───
  { code:'MYLC001',name:'余额宝(天弘余额宝货币)',type:'货币基金', market:'支付宝理财', focus:'货币基金/T+0' },
  { code:'MYLC002',name:'蚂蚁财富-短债基金优选',type:'理财', market:'支付宝理财', focus:'短债/稳健' },
  { code:'MYLC003',name:'蚂蚁财富-固收增强',type:'理财', market:'支付宝理财', focus:'固收+/增强' },
  { code:'MYLC004',name:'蚂蚁财富-指数定投(沪深300)',type:'理财', market:'支付宝理财', focus:'定投/沪深300' },
  { code:'MYLC005',name:'蚂蚁财富-帮你投(稳健)',type:'理财', market:'支付宝理财', focus:'投顾/稳健' },
  { code:'MYLC006',name:'蚂蚁财富-帮你投(均衡)',type:'理财', market:'支付宝理财', focus:'投顾/均衡' },
  { code:'MYLC007',name:'蚂蚁财富-帮你投(进取)',type:'理财', market:'支付宝理财', focus:'投顾/进取' },
  // ─── 更多银行理财 ───
  { code:'ICBC001',name:'工银理财-核心优选系列',type:'理财', market:'银行理财', focus:'固收/核心' },
  { code:'ICBC002',name:'工银理财-鑫添益系列',type:'理财', market:'银行理财', focus:'固收+/添益' },
  { code:'ICBC003',name:'工银理财-全鑫权益系列',type:'理财', market:'银行理财', focus:'权益/混合' },
  { code:'ICBC004',name:'工银理财-美元优享系列',type:'理财', market:'银行理财', focus:'美元/固收' },
  { code:'CCB001',name:'建信理财-嘉鑫系列(月)',type:'理财', market:'银行理财', focus:'固收/月度' },
  { code:'CCB002',name:'建信理财-嘉鑫系列(季)',type:'理财', market:'银行理财', focus:'固收/季度' },
  { code:'CCB003',name:'建信理财-嘉鑫系列(年)',type:'理财', market:'银行理财', focus:'固收/年度' },
  { code:'CCB004',name:'建信理财-海鑫系列(美元)',type:'理财', market:'银行理财', focus:'美元/固收' },
  { code:'ABC001',name:'农银理财-农银匠心系列',type:'理财', market:'银行理财', focus:'固收/匠心' },
  { code:'ABC002',name:'农银理财-农银进取系列',type:'理财', market:'银行理财', focus:'混合/进取' },
  { code:'ABC003',name:'农银理财-农银同心系列',type:'理财', market:'银行理财', focus:'ESG/绿色' },
  { code:'BOC001',name:'交银理财-稳享系列(3个月)',type:'理财', market:'银行理财', focus:'固收/3个月' },
  { code:'BOC002',name:'交银理财-稳享系列(6个月)',type:'理财', market:'银行理财', focus:'固收/6个月' },
  { code:'BOC003',name:'交银理财-博享系列(混合)',type:'理财', market:'银行理财', focus:'混合/博享' },
  { code:'SPDB001',name:'浦发理财-悦盈利系列',type:'理财', market:'银行理财', focus:'固收/悦盈' },
  { code:'SPDB002',name:'浦发理财-益鑫利系列',type:'理财', market:'银行理财', focus:'混合/益鑫' },
  { code:'CIB001',name:'兴业理财-添利系列',type:'理财', market:'银行理财', focus:'固收/添利' },
  { code:'CIB002',name:'兴业理财-睿盈系列',type:'理财', market:'银行理财', focus:'混合/睿盈' },
  { code:'PAB001',name:'平安理财-天天成长系列',type:'理财', market:'银行理财', focus:'现金管理/T+0' },
  { code:'PAB002',name:'平安理财-启航系列',type:'理财', market:'银行理财', focus:'固收/启航' },
  { code:'PAB003',name:'平安理财-美元启航系列',type:'理财', market:'银行理财', focus:'美元/固收' },
];
